...
<body>
    ...
    <div class="container box">
        ...
        <br>
        <h2 style="color: whitesmoke;" align="left">Student Signup</h2><br>
        ...
        <form method="post" action="Student2.php">
            <div class="container">
                ...
                <div class="input">
                    <i class="fa-solid fa-lock icon"></i>
                    <input type="password" class="input-field" name="password2" id="pass1"
                        placeholder="Confirm Password" required>
                </div>
            </div><br>
            <?php if ($_SESSION['stdlogin'] == 'Yes') { ?>
            ...
            <?php if ($_SESSION['stdlogin'] == 'pass') { ?>
            <div class="alert alert-danger alert-dismissible">
                <strong>Alert!</strong> Enter same passwords.
                <button type="button" class="btn" data-bs-dismiss="alert" style="float: right;"
                    onclick="<?php $_SESSION['stdlogin'] = ''; ?>"><i class="fa-solid fa-xmark"></i></button>
            </div>
            <?php } ?>

            <?php if ($_SESSION['userexist'] == 'Yes') { ?>
            <div class="alert alert-danger alert-dismissible">
                <strong>Alert!</strong> Username Already Taken try another.
                <button type="button" class="btn" data-bs-dismiss="alert" style="float: right;"
                    onclick="<?php $_SESSION['userexist'] = ''; ?>"><i class="fa-solid fa-xmark"></i></button>
            </div>
            <?php } ?>
            ...
            <input type="submit" class="container-fluid" name="submit" value="Signup" id="login"><br><br>
            <p style="padding-left:20%">Alredy registered? Signin <a href="StudentLogin.php">Here</a></p>
        </form>
    </div>
    </div>
