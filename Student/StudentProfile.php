...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-fixed-top sticky" style="background-color: #000;z-index:100;">
    ...
    <div class="container p-5 rounded shadow-lg bg-dark">
        ...
        <div class="row">
            ...
            <div class="col-6">
                ...
                <form method="post" action="Student2.php" enctype="multipart/form-data" class="input-group row">
        ...
        <div class="modal-dialog">
            <form method="post" action="Student2.php" class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="submit" name="profile" id="admin" class="btn btn-primary">Submit</button>
