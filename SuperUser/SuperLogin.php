...
<div class="container box">
    ...
    <br><h2 style="color: whitesmoke;" align="left">Log in</h2><br>
    ...
    <form method="post" action="Super2.php">
      <div class="container">
        ...
        <div class="input">
          ...
          <input type="password" class="input-field" name="password" id="pass" placeholder="Password" required>
        </div>
      </div><br>
        <?php if($_SESSION['login']=='No'){?>
            <div class="alert alert-danger alert-dismissible">
                <strong>Alert!</strong> Wrong Login credentials...
                <button type="button" class="btn" data-bs-dismiss="alert" style="float: right;" onclick="<?php $_SESSION['login']='Yes'; ?>"><i class="fa-solid fa-xmark"></i></button>
            </div>
        <?php }?>
